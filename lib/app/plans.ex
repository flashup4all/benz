defmodule App.Plans do
  ...
  """
  def list_plans(params) do
    Plan |> Repo.paginate(params)
  end
  @doc """
  Returns the list of plans that belongs to a particular user.
  ...
  """
  def user_plans(id, params) do
    Plan |> where(user_id: ^id) |> Repo.paginate(params)
  end
